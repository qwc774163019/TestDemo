...
import com.qi.wenchao.testdemo.R;


/**
 * @author chao
 * @Description {todo}
 * @date 2018/1/23 下午3:52
 * @todo:
 */
public class ArcView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setShadowLayer(10,mWidth/2, mHeight+mArcHeight,0x80c8c8c8);
        Path path = new Path();
        path.moveTo(0, 0);
        path.quadTo(mWidth/2, mHeight+mArcHeight, mWidth, 0);
